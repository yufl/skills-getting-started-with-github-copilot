...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the competitive basketball team for interscholastic play",
    ...
    "Music Band": {
        "description": "Perform in the school band with instruments of your choice",
        "schedule": "Mondays and Fridays, 4:00 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "mia@mergington.edu"]
    },
    "Debate Club": {
        "description": "Build public speaking and argumentation skills through debate",
